      ...
      <tbody>
        ...
        <?php else:
          foreach ($assignments as $a): ?>
            <tr>
              <td style="font-family: monospace; font-weight: 700; color: var(--asset-primary);"><?php echo $a['asset']; ?>
              </td>
              <td style="font-weight: 700;"><?php echo $a['item']; ?></td>
              <td>
                <div style="display: flex; align-items: center; gap: 10px;">
                  <div
                    ...
                    <?php echo strtoupper(substr($a['user'], 0, 1)); ?>
                  </div>
                  <span style="font-weight: 600;"><?php echo $a['user']; ?></span>
                </div>
              </td>
              <td><span style="font-size: 13px; color: var(--asset-muted);"><?php echo $a['role']; ?></span></td>
              <td style="font-weight: 500;"><?php echo date('M d, Y', strtotime($a['date'])); ?></td>
              <td>
                <span
